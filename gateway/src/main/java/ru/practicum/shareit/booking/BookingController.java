...
public class BookingController {
    ...
    public ResponseEntity<Object> getBookings(@RequestHeader(OWNER_ID_HEADER) long userId,
        ...
        BookingState state = BookingState.from(stateParam)
                .orElseThrow(() -> new IllegalArgumentException("Несуществующий state: " + stateParam));
        log.info("Получить бронирование с state {}, userId={}, from={}, size={}", stateParam, userId, from, size);
    ...
    public ResponseEntity<Object> getAllBookingsByOwner(@RequestParam(defaultValue = "ALL") String state,
        ...
        BookingState stateParam = BookingState.from(state)
                .orElseThrow(() -> new BadRequestException("Несуществующий state: " + state));
        log.info("Получить бронирование с state {}, userId={}, from={}, size={}", state, userId, from, size);
